...
<head>
    ...
    <link rel="stylesheet" href="./PastriesandBreads.css">
</head>
<body>
    <header>
        <div class="topnav">
    ...
    <main>
        <div id="items">
            <section id="selection">
                ...
                // Retrieve menu data
                $sql = "SELECT name, description,image, price FROM menu_item WHERE category_name = 'Pastries and Breads' && menu_id = 2";
