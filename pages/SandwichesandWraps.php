...
<head>
    ...
    <link rel="stylesheet" href="../CSS/SandwichesandWraps.css">
    ...
    <main>
        <div id="items">
            <section id="selection">
                ...
                $sql = "SELECT id, name, description, image, price FROM menu_item WHERE category_name = 'Sandwiches and Wraps' && menu_id = 1";
